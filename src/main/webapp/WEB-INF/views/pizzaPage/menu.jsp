                ...
                <div class="col-lg-4 d-flex ftco-animate">
                    <div class="services-wrap d-flex">
                        ...
                        <div class="text p-4">
                            ...
                            <p class="price"><span>${title.price}</span> <a href=''
                ...
                <div class="row">
                    <div class="col-md-12 nav-link-wrap mb-5">
                        <div class="nav ftco-animate nav-pills" id="v-pills-tab" role="tablist"
                            ...
                            <c:forEach items="${category}" var="title1" varStatus="loop">
                                <%--		              <a class="nav-link active" id="v-pills-1-tab" data-toggle="pill" href="#v-pills-1" role="tab" aria-controls="v-pills-1" aria-selected="false">${title1.categoryName}</a>--%>

                                <a class="nav-link" id=${'v-pills-'.concat(loop.index+1).concat("-tab")} data-toggle="pill" href="${'#v-pills-'.concat(loop.index+1)}" role="tab"
                                   aria-controls="${'v-pills-'.concat(loop.index+1)}" aria-selected=<c:if test="${loop.index==0}">true</c:if><c:if test="${loop.index!=0}">false</c:if> >${title1.categoryName}</a>
                            </c:forEach>
                    ...
                    <div class="col-md-12 d-flex align-items-center">
                        <div class="tab-content ftco-animate" id="v-pills-tabContent">
                            <c:forEach items="${categoryMap}" var="entry" varStatus="loop">
                                <div class="tab-pane fade <c:if test="${loop.index == 0}">show active</c:if>" id="${'v-pills-'.concat(loop.index+1)}" role="tabpanel"
                            ...
                            <!--potrzebujemy: info jaka kategoria jaka lista, info ktore elementy sa kolejno wyswietlane-->
