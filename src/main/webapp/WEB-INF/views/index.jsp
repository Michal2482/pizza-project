    ...
    <section class="ftco-intro">
    	<div class="container-wrap">
    		<div class="wrap d-md-flex">
	    		<div class="info">
	    			<div class="row no-gutters">
	    				...
	    				<div class="col-md-3 d-flex ftco-animate">
	    					...
	    					<div class="text">
	    						<h3>Address</h3>
	    						<p>${basicInformation.city} ${basicInformation.street} ${basicInformation.propertyNumber}</p>
	    					</div>
	    				</div>
	    				<div class="col-md-3 d-flex ftco-animate">
							...
							<div class="text">
	    						<h3>Open Hours:</h3>
	    						<p>Monday: ${basicInformation.openHoursMondayFrom} - ${basicInformation.openHoursMondayTo}</p>
								<p>Tuesday: ${basicInformation.openHoursTuesdayFrom} - ${basicInformation.openHoursTuesdayTo}</p>
								<p>Wednesday: ${basicInformation.openHoursWednesdayFrom} - ${basicInformation.openHoursWednesdayTo}</p>
								<p>Thursday: ${basicInformation.openHoursThursdayFrom} - ${basicInformation.openHoursThursdayTo}</p>
	    					</div>
	    				</div>
						<div class="col-md-3 d-flex ftco-animate">

							<div class="text">
								<p>Friday: ${basicInformation.openHoursFridayFrom} - ${basicInformation.openHoursFridayTo}</p>
								<p>Saturday: ${basicInformation.openHoursSaturdayFrom} - ${basicInformation.openHoursSaturdayTo}</p>
								<p>Sunday: ${basicInformation.openHoursSundayFrom} - ${basicInformation.openHoursSundayTo}</p>
							</div>
						</div>
	    			</div>
	    		</div>
              ...
              <li class="ftco-animate"><a href="${basicInformation.twitterUrl}"><span class="icon-twitter"></span></a></li>
              <li class="ftco-animate"><a href="${basicInformation.facebookUrl}"><span class="icon-facebook"></span></a></li>
              <li class="ftco-animate"><a href="${basicInformation.instagramUrl}"><span class="icon-instagram"></span></a></li>
            </ul>
	    		</div>
    		</div>
    	</div>
